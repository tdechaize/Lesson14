# Lesson14
Leson14 OpenGL (from NeHe)

Vous trouverez dans le sommaire ci-dessous les explications concernant cette application illustrant un exemple d'usage d'OpenGL : une Outline Font 
(en provenance du site NeHe).
...
Voici en résumé ce qui est disponible pour cet example :

## OpenGL Tutorial #14.

Project Name: Jeff Molofee's OpenGL Tutorial

Project Description : Outline Font Tutorial
