...
* \brief           Ouvre une simple fenêtre Windows et dessine un texte en rotation généré à partir d'une fonte outline.
...
*
* \brief      Fonction glPrint : une impression adaptée
* \details    Cette fonction imprime un format quelconque ...
* \param      fmt           le format à imprimer
* \return     GLvoid        un void OpenGL.
*
*/
